...
if( ! function_exists( 'online_eshop_getting_started_menu' ) ) :
/**
 * Adding Getting Started Page in admin menu
 */
function online_eshop_getting_started_menu(){	
	add_theme_page(
		__( 'Getting Started', 'online-eshop' ),
		__( 'Getting Started', 'online-eshop' ),
		'manage_options',
		'online-eshop-getting-started',
		'online_eshop_getting_started_page'
        
	);
}
endif;
add_action( 'admin_menu', 'online_eshop_getting_started_menu' );

if( ! function_exists( 'online_eshop_getting_started_admin_scripts' ) ) :
/**
 * Load Getting Started styles in the admin
 */
function online_eshop_getting_started_admin_scripts( $hook ){
	// Load styles only on our page
	if( 'appearance_page_online-eshop-getting-started' != $hook ) return;

    wp_enqueue_style( 'online-eshop-getting-started', get_template_directory_uri() . '/inc/getting-started/css/getting-started.css', false);
    
    wp_enqueue_script( 'plugin-install' );
    wp_enqueue_script( 'updates' );
    wp_enqueue_script( 'online-eshop-getting-started', get_template_directory_uri() . '/inc/getting-started/js/getting-started.js', array( 'jquery' ), true );
    wp_enqueue_script( 'online-eshop-recommended-plugin-install', get_template_directory_uri() . '/inc/getting-started/js/recommended-plugin-install.js', array( 'jquery' ), true );    
    wp_localize_script( 'online-eshop-recommended-plugin-install', 'online_eshop_start_page', array( 'activating' => __( 'Activating ', 'online-eshop' ) ) );
}
endif;
add_action( 'admin_enqueue_scripts', 'online_eshop_getting_started_admin_scripts' );

if( ! function_exists( 'online_eshop_call_plugin_api' ) ) :
/**
 * Plugin API
**/
function online_eshop_call_plugin_api( $plugin ) {
...
if( ! function_exists( 'online_eshop_check_for_icon' ) ) :
/**
 * Check For Icon 
**/
function online_eshop_check_for_icon( $arr ) {
	if( ! empty( $arr['svg'] ) ){
...
if( ! function_exists( 'online_eshop_getting_started_page' ) ) :
/**
 * Callback function for admin page.
*/
function online_eshop_getting_started_page(){ ?>
	<div class="wrap getting-started">
		<h2 class="notices"></h2>
		<div class="intro-wrap">
			<div class="intro">
				<h3><?php printf( esc_html__( 'Getting started with %1$s v%2$s', 'online-eshop' ), ONLINE_ESHOP_THEME_NAME, ONLINE_ESHOP_THEME_VERSION ); ?></h3>
                <h4><?php printf( esc_html__( 'You will find everything you need to get started with %1$s below.', 'online-eshop' ), ONLINE_ESHOP_THEME_NAME ); ?></h4>
			</div>
		</div>
			...
			<ul class="inline-list">
				<li class="current">
                    <a id="plugins" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Recommended Plugins', 'online-eshop' ); ?>
                    </a>
                </li>
				<li>
                    <a id="help" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Getting Started', 'online-eshop' ); ?>
                    </a>
                </li>
				<li>
                    <a id="support" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'FAQ\'s &amp; Support', 'online-eshop' ); ?>
                    </a>
                </li>
				<li>
                    <a id="free-pro-panel" href="javascript:void(0);">
                        ...
                        <?php esc_html_e( 'Free Vs Pro', 'online-eshop' ); ?>
                    </a>
                </li>
			</ul>
